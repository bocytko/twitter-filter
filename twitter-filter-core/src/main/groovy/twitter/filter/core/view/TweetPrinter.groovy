...
class TweetPrinter {
    ...
    void printHtml(Tweet tweet, def relatedTweets) {
        println getHtml(tweet, relatedTweets)
    }

    def getHtml(Tweet tweet, def relatedTweets) {
        ...
        <div class="tweet_row" style="margin: 10px; font-family: Verdana; font-size: 10pt">
            ...
            <div class="tweet_info" style="font-weight: bold;"><a href="https://twitter.com/#!/${tweet.from_user}">${tweet.from_user}</a> (${relatedTweets.size()})</div>
